...
The work of this paper provides a novel thermodynamic point of view for the urban transportation network.
\end{abstract}

\begin{keyword}
Transportation systems\sep thermodynamic systems \sep entropy\sep dissipativity theory\sep Shannon \end{keyword}
...
In detail, this paper will firstly show the connections between the transportation system and the thermodynamic system. Based on them, the correspondence of the basic concepts will be presented. Then, it will be demonstrated that the transportation system can have a similar notion of the entropy to measure the system disorder. By considering this new entropy notion as the storage function, a dissipativity law will be then presented, which can reduce the disorder and hence render the system better organized. Furthermore, it will be shown that the nominal situation in transportation systems is similar with the closed status in thermodynamic systems, and the equilibrium can also be introduced to represent the state when all traffic lanes have the same occupancy.
...
The work in this paper is a completely new attempt to discover the nature of transportation systems, which can be further applied in traffic signal control.
