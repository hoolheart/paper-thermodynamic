...
situation in transportation systems is similar with the isolated
status in thermodynamic ones.
...
equilibrium into the transportation context. For an isolated
...
maximal entropy and minimal ectropy in the isolated thermodynamic
system.
...
equilibrium leads to the minimal disorder in the network. It is
interesting to consider the possibility that certain control strategy
can render the system approximate to such state. However, it must be
noted that this equilibrium comes only from the correspondence
between temperature and occupancy. There is no proof that this would
be a stable state for the transportation system.
...
In further investigations, we would explore more applications of
thermodynamic concepts in transportation context. In our opinion,
this approach has the potential to design better control strategies.
