...
It well known that the solution set of  the LMI
\eqref{equ:lmi} has a solution  matrix $H$ such
...
Indeed, there are two cases to consider:
 ...
 Moreover, if $\mat{R}=r\mat{I}$ with $r\in \mathbb{R}$, then the
feedback control law 
$$\vec{u}=\frac{r}{2} (\mat{Q}\mat{Q}^T)^{-1}\mat{B}^T\mat{P}
(\mat{A}\vec{x}+\vec{r})$$
 renders the system dissipative if $|r+1|\leq 1$.
